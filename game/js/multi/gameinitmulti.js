    ...
    // var changelevel;
        ...
        return {
                ...
                // }
                   ...
                   var mesh, body;
                    ...
                    while (i--){
                        ...
                        if ( ( host && v3d.scene.children[V3D.mesharrpos.planetGlow].material.uniforms.glowFloat.value > 1.5 && endsequence > 0 ) ){
            ...
            planetex: function() {
                ...
                v3d.scene.add( a123 );
                // change to live
                //v3d.scene.children[V3D.mesharrpos.planetGlow].material.uniforms.glowFloat.value = 0;
